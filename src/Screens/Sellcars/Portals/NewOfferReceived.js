          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.content}>
              ...
              <AppText style={styles.subtitle}>
                <Text style={styles.bold}>John Jacobson</Text> has sent an offer
              ...
              <View style={styles.priceBox}>
                ...
                <View style={styles.priceRow}>
                  <AppText
                    style={[styles.priceLabel, { color: AppColors.link }]}
                  >
                    Incoming Offer:
                  </AppText>
                  <AppText
                    style={[styles.priceValue, { color: AppColors.link }]}
                  >
                    £{offerPrice}
                  </AppText>
                </View>
              ...
              {showCounterOffer && (
                <>
                  <AppText style={[styles.priceLabel, { marginTop: 16 }]}>
                    Your Counter-Offer:
                  </AppText>
                  <AppInput
                  ...
                  />
                  <AppText style={styles.subtitle}>
                    <Text style={styles.bold}>Please note:</Text> If your
                    counter-offer is accepted, an invoice containing the
                    newly-agreed price will be sent to the buyer.
                  </AppText>
                </>
              )}
              ...
              {!showCounterOffer && (
                <AppTouchable
                  ...
                  style={styles.decideLaterContainer}
                >
                  <AppText style={styles.decideLaterText}>
                    Decide Later (3:59 Remaining)
                  </AppText>
                </AppTouchable>
              )}
            </View>
