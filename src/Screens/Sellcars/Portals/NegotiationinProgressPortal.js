...
const NegotiationinProgressPortal = ({
    visible,
    onCounter,
    onDismiss,
    car,
                ...
                >
                    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                        <View style={styles.content}>
                            <AppText style={styles.title}>Negotiation in Progress</AppText>
                            <AppText style={styles.subtitle}>
                                You have sent a counter-offer to
                                <Text style={styles.bold}> John Jacobson</Text> for the following motor:
                            </AppText>
                            ...
                            <View style={styles.priceBox}>
                                <View style={styles.priceRow}>
                                    ...
                                    <AppText style={styles.priceValue}>{car.price}</AppText>
                                </View>
                                ...
                                <View style={[styles.priceRow, {
                                    ...
                                    <AppText style={[styles.priceLabel, { color: AppColors.Blue_Subtext }]}>Incoming Offer:</AppText>
                                    <AppText style={[styles.priceValue, { color: AppColors.Blue_Subtext }]}>{car.price}</AppText>
                                </View>
                            </View>
                            {/* ---------- */}
                            <View style={[styles.priceRow, {
                                ...
                                <AppText style={[styles.priceLabel, { color: AppColors.link }]}>Your Counter:</AppText>
                                <AppText style={[styles.priceValue, { color: AppColors.link }]}>{car.price}</AppText>
                            </View>


                            <AppText style={styles.subtitle}>
                                <AppText style={styles.bold}>Please note: </AppText>
                                If your counter-offer is accepted,
                                an invoice containing the newly-agreed
                                price will be sent to the buyer.
                            </AppText>
                            <View style={styles.sendOfferbuttonContainer}>
                                <AppTouchable onPress={onDismiss} style={styles.sendOfferbutton}>
                                    <AppText style={styles.declineText}>Go Back</AppText>
                                </AppTouchable>
                                <AppTouchable
                                    onPress={onCounterClicked}
                                    style={[styles.sendOfferbutton, { borderBottomRightRadius: 16 }]}
                                >
                                    <AppText style={styles.counterText}>Offer Pending</AppText>
                                </AppTouchable>
                            </View>
...
export default NegotiationinProgressPortal;
