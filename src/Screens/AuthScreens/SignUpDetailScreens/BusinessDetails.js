...
const BusinessDetails = () => {
    ...
    const handleConfirm = () => {
        ...
        if (form.businessWebsite && !urlRegex.test(form.businessWebsite.trim())) {
            ...
            >
                ...
                <ScrollView keyboardShouldPersistTaps={'handled'} contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.inputsMainCnatiner}>
                        ...
                        <AppInput
                            label="Confirm Business Email Address *"
                            keyboardType="email-address"
                        ...
                        <AppInput label="1st Line of Business Address *" value={form.address1} onChangeText={(val) => handleChange('address1', val)} errorMessage={errors.address1} />
                        <AppInput label="2nd Line of Business Address" value={form.address2} onChangeText={(val) => handleChange('address2', val)} errorMessage={errors.address2} />
                        ...
                        <AppInput
                            ...
                            onChangeText={(val) => handleChange('businessWebsite', val)}
