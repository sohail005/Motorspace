...
const BusinessDetails = () => {
    ...
    const inputFields = [
        ...
        { key: 'email', label: 'Business Email Address *', keyboardType: 'email-address' },
        { key: 'confirmEmail', label: 'Confirm Business Email Address *', keyboardType: 'email-address' },
        { key: 'phone', label: 'Phone Number *', keyboardType: 'phone-pad' },
        { key: 'address1', label: '1st Line of Business Address *' },
        { key: 'address2', label: '2nd Line of Business Address' },
        { key: 'city', label: 'Town/City *' },
        { key: 'county', label: 'County *' },
        { key: 'postcode', label: 'Postcode *' },
        { key: 'businessWebsite', label: 'Business Website (if applicable)', keyboardType: 'url' },
            ...
            >
                ...
                >
                    <View style={styles.inputsMainCnatiner}>
                        <AppText style={styles.Heading}>Tell Us a Bit About Your Business</AppText>
