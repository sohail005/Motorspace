...
const ConfirmQuickBuyPortal = ({
    ...
    return (
        <Portal>
            ...
            >
                <View style={styles.HeadeingConatienr}>
                    <AppText style={styles.heading}>Confirm </AppText>
                    <AppText style={styles.headingBold}>Quick Buy</AppText>
                </View>
...
export default ConfirmQuickBuyPortal;
