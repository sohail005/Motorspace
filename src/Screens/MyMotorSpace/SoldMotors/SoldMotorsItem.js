...
const getCardColor = (status) => {
    switch (status) {
        ...
        case 'SALE PENDING':
        case 'FOR SALE': return AppColors.quickbuy;
...
const getStatusColor = (status) => {
    switch (status) {
        case 'OFFER RECEIVED': return AppColors.link;
        case 'INCOMING OFFER': return AppColors.link;
        case 'ARCHIVED': return AppColors.Blue_Subtext;
        case 'FOR SALE': return AppColors.quickbuy;
        default: return AppColors.textPrimary;
    }
};

const SoldMotorsItem = ({ item, onPress }) => {
    const {
        title,
        variant,
        numberPlate,
