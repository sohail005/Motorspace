...
import { soldMotorsData } from './data';
...
import SoldMotorsItem from './SoldMotorsItem';
import { styles } from './SoldMotorsStyles';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.scrollContent}>
                ...
                <AppFlatList
                    ...
                    renderItem={({ item }) => (
                        <SoldMotorsItem item={item} onPress={() => onItemPress(item)} />
                    )}
                    ListHeaderComponent={
